...
def run_branch3freq(file_path):
    ...
    for i in range(len(H)):
        ...
        Z2[y_idx, x_idx] = (branch3Freq[i])
        Z2_r[y_idx, x_idx] = (branch3Freq_r - branch3Freq[i])
    ...
    for i in range(len(H)):
        ...
        Z3[y_idx, x_idx] = (branch3Freq[i])
        Z3_r[y_idx, x_idx] = (branch3Freq_r - branch3Freq[i])
    ...
    for i in range(len(alpha1)):
        ...
        y_idx = np.where(np.unique(beta2) == beta2[i])[0]
        Z4[y_idx, x_idx] = (branch3Freq[i])
        Z4_r[y_idx, x_idx] = (branch3Freq_r - branch3Freq[i])
    ...
    for i in range(len(alpha1)):
        x_idx = np.where(np.unique(alpha1) == alpha1[i])[0]
        y_idx = np.where(np.unique(beta1) == beta1[i])[0]
        Z5[y_idx, x_idx] = (branch3Freq[i])
        Z5_r[y_idx, x_idx] = (branch3Freq_r - branch3Freq[i])
    ...
    for i in range(len(beta2)):
        ...
        y_idx = np.where(np.unique(beta1) == beta1[i])[0]
        Z6[y_idx, x_idx] = (branch3Freq[i])
        Z6_r[y_idx, x_idx] = (branch3Freq_r - branch3Freq[i])
    ...
    cbar2.set_label('branch3Freq_residual (Hz)')
    ...
    cbar3.set_label('branch3Freq_residual (Hz)')
    ...
    cbar4.set_label('branch3Freq_residual (Hz)')
    ...
    cbar5.set_label('branch3Freq_residual (Hz)')
    ...
    cbar6.set_label('branch3Freq_residual (Hz)')

    axes[0, 1].remove()
    axes[0, 2].remove()
    axes[1, 2].remove()

    fig.suptitle('frequency of branch 3 residual', fontsize=16)
